...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        closestDistanceToClosestGhost = float("inf")
        bestAction = None
        for action in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, action)
            distanceToClosestGhost = self.distancer.getDistance(successorPosition, closestGhostPosition)
            if distanceToClosestGhost < closestDistanceToClosestGhost:
                closestDistanceToClosestGhost = distanceToClosestGhost
                bestAction = action
        return bestAction
        "*** END YOUR CODE HERE ***"
